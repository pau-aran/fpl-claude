...
6. A5/A6/A7 (data breadth, minutes v2, weekly-report dry-run) as capacity allows.
7. B items when the 2026/27 season opens (the network half is already unblocked locally).
