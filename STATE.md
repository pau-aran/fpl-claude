# Session State — updated 2026-07-25 (code session — A3 + A4 shipped, both ADVISORY)

*Handoff snapshot. Read this first, then `NEXT-STEPS-IMPLEMENTATION.md` for the buildable
backlog and `reports/backtest/2025-26/knowledge.md` for the distilled decision knowledge.
GW1 deadline ≈ mid-August 2026 (~3 weeks out).
NOTE: `NEXT-STEPS.md` (the road-to-GW1 roadmap) was DELETED on `main` by a parallel session
on 2026-07-25; this file and `NEXT-STEPS-IMPLEMENTATION.md` still reference it. Restore it or
drop the references — unresolved.*

## Latest: A3 + A4 shipped (2026-07-25, branch `claude/a3-a4-calibration-multiperiod`)
